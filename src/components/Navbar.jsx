...
function Navbar() {
  ...
  return (
    <nav className=" py-1 bg-[#e27321] py-4  ">
      <div className="container-wrapper flex items-center justify-between relative">
        <div className=" flex items-center gap-2">
      

          <p className=" text-xl font-bold font-groot-one text-[#ffffff] ">
          ⁠Spider Monkey
          </p>
        </div>
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-4 text-xl [&_a:hover]:opacity-70">
            <a target="_blank" href="https://twitter.com/spidermonkeeyyy" className=" text-2xl">
              <FaTwitter fill="#fff" />
            </a>
            <a target="_blank" href="https://t.me/spimonkey" className=" text-2xl">
